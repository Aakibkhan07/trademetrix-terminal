  ...
  return (
    <div style={{ maxWidth: 700, margin: '0 auto' }}>
      ...
      <div className="t-panel" style={{ padding: 20, fontSize: 12, lineHeight: 1.7 }}>
        <p>No refund policy applicable as the platform does not process payments directly. All access-related inquiries can be directed to support@trademetrix.tech.</p>
      </div>
    </div>
  )
}
