...
export default function EquityCurve({ points, height = 200 }: EquityCurveProps) {
  ...
  return (
    <svg viewBox={`0 0 ${width} ${height}`} style={{ width: '100%', height: 'auto' }}>
        ...
        return (
          <g key={i}>
            <line x1={padding.left} y1={y} x2={width - padding.right} y2={y} stroke="rgba(139,92,246,0.08)" strokeWidth={1} />
              <text x={padding.left - 8} y={y + 4} textAnchor="end" fill="#555570" fontSize={10} fontFamily="'DM Sans', sans-serif">
      ...
      <text x={padding.left} y={padding.top - 8} fill={lineColor} fontSize={11} fontFamily="'DM Sans', sans-serif" fontWeight={600}>
