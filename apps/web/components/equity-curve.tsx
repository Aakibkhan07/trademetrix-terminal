...
export default function EquityCurve({ points, height = 200 }: EquityCurveProps) {
  ...
  return (
    <svg viewBox={`0 0 ${width} ${height}`} style={{ width: '100%', height: 'auto' }}>
      ...
      {Array.from({ length: yTicks + 1 }).map((_, i) => {
        ...
        return (
          <g key={i}>
            ...
            <text x={padding.left - 8} y={y + 4} textAnchor="end" fill="#555570" fontSize={10} fontFamily="DM Sans">
      ...
      <text x={padding.left} y={padding.top - 8} fill={lineColor} fontSize={11} fontFamily="DM Sans" fontWeight={600}>
