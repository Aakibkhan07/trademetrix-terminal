...
YAHOO_SYMBOL_MAP: dict[str, str] = {
    ...
    "NIFTYCONSR": "^CNXCONSUM",
    "NIFTYOILGAS": "^CNXOILGAS",
    "NIFTYDIVOP": "^CNXDIVOP",
    "NIFTYGSEC": "^CNXGSEQ",
    "BSE:SENSEX-INDEX": "^BSESN",
    "NIFTY50-INDEX": "^NSEI",
    "NIFTYBANK-INDEX": "^NSEBANK",
    "FINNIFTY-INDEX": "NIFTY_FIN_SERVICE.NS",
    "MIDCPNIFTY-INDEX": "^NSEMDCP50",
    "INDIAVIX-INDEX": "^INDIAVIX",
    "NIFTYIT-INDEX": "^CNXIT",
    "NIFTYPHARMA-INDEX": "^CNXPHARMA",
    "NIFTYAUTO-INDEX": "^CNXAUTO",
    "NIFTYFMCG-INDEX": "^CNXFMCG",
    "NIFTYMETAL-INDEX": "^CNXMETAL",
    "NIFTYREALTY-INDEX": "^CNXREALTY",
    "NIFTYENERGY-INDEX": "^CNXENERGY",
    "NIFTYMEDIA-INDEX": "^CNXMEDIA",
    "NIFTYPSUBANK-INDEX": "^CNXPSUBANK",
    "NIFTYPVTBANK-INDEX": "^NIFTY_PVT_BANK",
    "NIFTYCONSR-INDEX": "^CNXCONSUM",
    "NIFTYOILGAS-INDEX": "^CNXOILGAS",
    "NIFTYDIVOP-INDEX": "^CNXDIVOP",
    "NIFTYGSEC-INDEX": "^CNXGSEQ",
