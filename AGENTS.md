...
## Session: 2026-08-03 — Production Readiness v1.1.0 + hotfixes + Fyers rate-limit compliance (live-data pages, full E2E, v1.1.2)
...
- API regression: `.venv/bin/python -m pytest tests/` → **573 passed, 1 xfailed** (bare `pytest` collects root `pat_test.py` → sys.exit).
